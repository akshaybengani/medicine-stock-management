        ...
        <div class="row">
            ...
            <div class="col-md-6">
                 <div class="panel panel-primay"> 
                    <div class="panel-heading">Enter the Medicine Details</div>
                    <div class="panel-body">
                        <?php
                            ...
                            if(isset($_GET["update"]))
                            {
                                $id = $_GET['id'] ?? null;
                                //$where = array("id"=>$id);
                                // $obj->select_record("madicines",$id);
                                 $medicine = $obj->seletion_med("madicines",$id);
                        ...
                        <form action="#" method="post">
                            <table class="table table:hover">
                                <tr>
                                    <td>Medicine Name</td>
                                    <td><input type="text" class="form-control" name="name" value="<?php echo $row['m_name'];?>"></td>
                                </tr>
                                <tr>
                                    <td>quantity</td>
                            ...
                            <?php
                             ...
                             if(isset($_POST['update']))
                             {
                                ...
                                if($obj->select_record("madicines",$myArray2,$id))
                                {
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <table class="table table-bordered">
                    ...
                    <?php
                    $medi =  $obj->fetch_record("madicines");
                    foreach($medi as $row)
                    {
                    ?>
                    <tr>
