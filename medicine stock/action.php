...
class DataOperation extends DataBase
{
    ...
    public function select_record($table,$where,$id)
    {
        ...
        // $sql = "UPDATE ".$table." SET m_name='".$newname."',qty='".$qty."' WHERE id='".$id."'";
        $sql = "";
        $sql .= "UPDATE ".$table." SET m_name='";
        $sql .= $where['m_name']."',qty='".$where['qty']."' WHERE id='".$id."'";
        $query = mysqli_query($this->con,$sql);
        if($query)
        {
            return true;
...
if(isset($_POST['submit']))
{
    ...
    if($obj->insert_record("madicines",$myArray)){
...
{
    $id = $_GET['id'];
    if($obj->delete_record("madicines",$id))
    {
